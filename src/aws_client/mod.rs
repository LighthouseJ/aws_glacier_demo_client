...
pub mod aws_client
{
    ...
    async fn upload_parts(aws_info: &AwsCredentials, upload_info: &UploadInfo, part_size: u64, parts: &Vec<ByteRange>) -> Result<(), &'static str>
    {
        ...
        let initiate_res =
            glacier_client.initiate_multipart_upload(multipart_upload).await;
